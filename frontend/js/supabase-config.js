 ...
 * Learnove — Supabase client-side configuration.
 *
 * Replace SUPABASE_URL and SUPABASE_ANON_KEY with your actual
 * project values from: https://supabase.com/dashboard → project → Settings → API
 *
 * The anon key is SAFE to expose in the browser — it is locked down by
 * Row Level Security (RLS) policies on your database tables.
 */
